...
const group = 'Session CLI essentials';
  ...
  [
    {
      ...
      exec: ({ vscode }) => {
        vscode.window.showInformationMessage('Hello World! Session');
      },
    },
    {
      title: 'hey Session! show platform',
      exec: ({ vscode }) => {
        vscode.window.showInformationMessage(
          `Session platform is "${process.platform}"`,
        );
      },
    },
  ] as CommandType[]
